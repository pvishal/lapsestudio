...
namespace Timelapse_API
{
	...
	{
		private void Write301(StreamWriter writer)
		{
		...
		private void Read301(string[] lines)
		{
			CultureInfo culture = new CultureInfo("en-US");
			...
			Values.Add("SharpenEdge.Strength", new PP3entry("SharpenEdge.Strength", Convert.ToDouble(GetValue(Llines[i]), culture), 0d, 100d)); i++;
			...
			Values.Add("ColorManagement.GammaValue", new PP3entry("ColorManagement.GammaValue", Convert.ToDouble(GetValue(Llines[i]), culture), 2.22d, 2.22d)); i++;
