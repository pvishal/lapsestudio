...
namespace Timelapse_API
{
	...
	{
		private void Write319(StreamWriter writer)
		{
			...
			writer.WriteLine("C-Chroma=" + ((double)Values["Colorappearance.C-Chroma"].Value).ToString(digits, culture));
		...
		private void Read319(string[] lines)
		{
			CultureInfo culture = new CultureInfo("en-US");
			...
			Values.Add("Colorappearance.C-Chroma", new PP3entry("Colorappearance.C-Chroma", Convert.ToDouble(GetValue(Llines[i]), culture), -100d, 100d)); i++;
            ...
            Values.Add("CoarseTransformation.Rotate", new PP3entry("CoarseTransformation.Rotate", Convert.ToInt32(GetValue(Llines[i])), null, null)); i++;
