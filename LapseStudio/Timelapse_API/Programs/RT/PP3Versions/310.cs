...
namespace Timelapse_API
{
	...
	{
		private void Write310(StreamWriter writer)
		{
			...
			writer.WriteLine("Scale=" + Values["EPD.Scale"].Value.ToString());
		...
		private void Read310(string[] lines)
		{
			CultureInfo culture = new CultureInfo("en-US");
			...
			Values.Add("EPD.Scale", new PP3entry("EPD.Scale", Convert.ToInt32(GetValue(Llines[i])), 0, 0)); i++;
