...
namespace Timelapse_API
{
	...
	{
		private void Write318(StreamWriter writer)
		{
			...
			writer.WriteLine("J-Light=" + Values["Colorappearance.J-Light"].Value.ToString());
			writer.WriteLine("Q-Bright=" + Values["Colorappearance.Q-Bright"].Value.ToString());
			writer.WriteLine("C-Chroma=" + Values["Colorappearance.C-Chroma"].Value.ToString());
			writer.WriteLine("S-Chroma=" + Values["Colorappearance.S-Chroma"].Value.ToString());
			writer.WriteLine("M-Chroma=" + Values["Colorappearance.M-Chroma"].Value.ToString());
			writer.WriteLine("J-Contrast=" + Values["Colorappearance.J-Contrast"].Value.ToString());
			writer.WriteLine("Q-Contrast=" + Values["Colorappearance.Q-Contrast"].Value.ToString());
			writer.WriteLine("H-Hue=" + Values["Colorappearance.H-Hue"].Value.ToString());
			writer.WriteLine("RSTProtection=" + Values["Colorappearance.RSTProtection"].Value.ToString());
		...
		private void Read318(string[] lines)
		{
			CultureInfo culture = new CultureInfo("en-US");
			...
			Values.Add("Colorappearance.J-Light", new PP3entry("Colorappearance.J-Light", Convert.ToInt32(GetValue(Llines[i])), -100, 100)); i++;
			Values.Add("Colorappearance.Q-Bright", new PP3entry("Colorappearance.Q-Bright", Convert.ToInt32(GetValue(Llines[i])), -100, 100)); i++;
			Values.Add("Colorappearance.C-Chroma", new PP3entry("Colorappearance.C-Chroma", Convert.ToInt32(GetValue(Llines[i])), -100, 100)); i++;
			Values.Add("Colorappearance.S-Chroma", new PP3entry("Colorappearance.S-Chroma", Convert.ToInt32(GetValue(Llines[i])), -100, 100)); i++;
			Values.Add("Colorappearance.M-Chroma", new PP3entry("Colorappearance.M-Chroma", Convert.ToInt32(GetValue(Llines[i])), -100, 100)); i++;
			Values.Add("Colorappearance.J-Contrast", new PP3entry("Colorappearance.J-Contrast", Convert.ToInt32(GetValue(Llines[i])), -100, 100)); i++;
			Values.Add("Colorappearance.Q-Contrast", new PP3entry("Colorappearance.Q-Contrast", Convert.ToInt32(GetValue(Llines[i])), -100, 100)); i++;
			Values.Add("Colorappearance.H-Hue", new PP3entry("Colorappearance.H-Hue", Convert.ToInt32(GetValue(Llines[i])), -100, 100)); i++;
			Values.Add("Colorappearance.RSTProtection", new PP3entry("Colorappearance.RSTProtection", Convert.ToInt32(GetValue(Llines[i])), 0, 100)); i++;
			...
			Values.Add("Gradient.Degree", new PP3entry("Gradient.Degree", Convert.ToInt32(GetValue(Llines[i])), 0, 180)); i++;
			Values.Add("Gradient.Feather", new PP3entry("Gradient.Feather", Convert.ToInt32(GetValue(Llines[i])), 25, 100)); i++;
			Values.Add("Gradient.Strength", new PP3entry("Gradient.Strength", Convert.ToDouble(GetValue(Llines[i]), culture), 0.6d, 5d)); i++;
			Values.Add("Gradient.CenterX", new PP3entry("Gradient.CenterX", Convert.ToInt32(GetValue(Llines[i])), 0, 100)); i++;
			Values.Add("Gradient.CenterY", new PP3entry("Gradient.CenterY", Convert.ToInt32(GetValue(Llines[i])), 0, 100)); i++;
			Values.Add("PCVignette.Enabled", new PP3entry("PCVignette.Enabled", Convert.ToBoolean(GetValue(Llines[i])), null, null)); i++;
			Values.Add("PCVignette.Strength", new PP3entry("PCVignette.Strength", Convert.ToDouble(GetValue(Llines[i]), culture), 0.6d, 6d)); i++;
			Values.Add("PCVignette.Feather", new PP3entry("PCVignette.Feather", Convert.ToInt32(GetValue(Llines[i])), 50, 100)); i++;
			Values.Add("PCVignette.Roundness", new PP3entry("PCVignette.Roundness", Convert.ToInt32(GetValue(Llines[i])), 50, 100)); i++;
