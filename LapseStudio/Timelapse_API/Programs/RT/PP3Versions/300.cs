...
namespace Timelapse_API
{
	...
	{
		private void Write300(StreamWriter writer)
		{
			...
			writer.WriteLine("Threshold=" + Values["Sharpening.Threshold"].Value.ToString());
			...
			writer.WriteLine("PSThreshold=" + Values["Vibrance.PSThreshold"].Value.ToString());
			...
			writer.WriteLine();
			writer.WriteLine("[Color Boost]");
			writer.WriteLine("Amount=" + Values["ColorBoost.Amount"].Value.ToString());
			writer.WriteLine("AvoidColorClipping=" + Values["ColorBoost.AvoidColorClipping"].Value.ToString().ToLower());
			writer.WriteLine("SaturationLimiter=" + Values["ColorBoost.SaturationLimiter"].Value.ToString().ToLower());
			writer.WriteLine("SaturationLimit=" + Values["ColorBoost.SaturationLimit"].Value.ToString());
			writer.WriteLine();
			...
			writer.WriteLine();
			writer.WriteLine("[Color Shift]");
			writer.WriteLine("ChannelA=" + Values["ColorShift.ChannelA"].Value.ToString());
			writer.WriteLine("ChannelB=" + Values["ColorShift.ChannelB"].Value.ToString());
			writer.WriteLine();
			...
			writer.WriteLine("LumCurve=" + ((PP3Curve)Values["DirectionalPyramidDenoising.LumCurve"].Value).ToString());
			writer.WriteLine("ChromCurve=" + ((PP3Curve)Values["DirectionalPyramidDenoising.ChromCurve"].Value).ToString());
			writer.WriteLine();
			writer.WriteLine("[Luminance Denoising]");
			writer.WriteLine("Enabled=" + Values["LuminanceDenoising.Enabled"].Value.ToString().ToLower());
			writer.WriteLine("Radius=" + ((double)Values["LuminanceDenoising.Radius"].Value).ToString(digits, culture));
			writer.WriteLine("EdgeTolerance=" + Values["LuminanceDenoising.EdgeTolerance"].Value.ToString());
			writer.WriteLine();
			writer.WriteLine("[Chrominance Denoising]");
			writer.WriteLine("Enabled=" + Values["ChrominanceDenoising.Enabled"].Value.ToString().ToLower());
			writer.WriteLine("Amount=" + Values["ChrominanceDenoising.Amount"].Value.ToString());
			writer.WriteLine();
			...
			writer.WriteLine("UseLensFun=" + Values["Distortion.UseLensFun"].Value.ToString().ToLower());
			writer.WriteLine();
